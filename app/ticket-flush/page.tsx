...
import TicketFlushBoard from "@/components/games/ticket-flush-board"
...
export default function TicketFlushPage() {
  ...
  const game = {
    name: "Transit Trench",
    lore: "Build sewer pipe routes through the underground network. Claim 5 routes first to win and flush the competition.",
  }
  ...
  const handleBetPlaced = (amount: number) => {
    ...
    toast({
      title: "Game Started",
      description: `Bet of ${amount} $DATX locked in. Build your pipe network!`,
    })
  }
      ...
      <div className="relative z-10 flex-1 py-8 px-4 lg:px-6 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-8">
            <div className="flex-1">
              ...
              <div className="mt-4 text-xs text-muted-foreground space-y-1">
                ...
                <p>🚂 Goal: Claim 5 routes to win</p>
                <p>🗺️ Draw cards or claim routes each turn</p>
                <p>🫧 Plunger Route: Draw an extra card</p>
              </div>
            </div>
          ...
          <Card className="glow-border bg-black/60 backdrop-blur border-2 p-4 lg:p-8 mb-8">
            {hasPlacedBet ? (
              <TicketFlushBoard gameBet={betAmount} />
            ) : (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <p className="text-muted-foreground mb-4">Place a bet to start Transit Trench</p>
