...
import BattleFlushBoard from "@/components/games/battle-flush-board"
...
export default function BattleFlushPage() {
  ...
  const game = {
    name: "Battle Breach",
    lore: "Plunger fleets clash in the sewer depths. Sink all enemy ships to dominate the sewers.",
  }
  ...
  const handleBetPlaced = (amount: number) => {
    ...
    toast({
      title: "Game Started",
      description: `Bet of ${amount} $DATX locked in. Sink the fleet!`,
    })
  }
  ...
  return (
    <main className="min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse at 20% 50%, rgba(0, 150, 255, 0.15) 0%, transparent 40%),
            radial-gradient(ellipse at 80% 80%, rgba(0, 200, 255, 0.1) 0%, transparent 50%),
            radial-gradient(ellipse at 50% 0%, rgba(100, 200, 255, 0.08) 0%, transparent 60%),
            linear-gradient(135deg, #0a1a2f 0%, #0a0a0a 50%, #0a1f2f 100%)
          `,
        }}
      />
      <div className="fixed inset-0 -z-10 bg-gradient-to-b from-blue-900/20 via-transparent to-black/60 backdrop-blur-sm top-20" />
      ...
      <div className="relative z-10 flex-1 py-8 px-4 lg:px-6 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-8">
            <div className="flex-1">
              ...
              <div className="mt-4 text-xs text-muted-foreground space-y-1">
                ...
                <p>🎯 Goal: Sink all enemy ships</p>
                <p>🚽 5 ships per player (sizes: 4,3,2,2,1)</p>
                <p>📡 One Radar Swirl reveal per player</p>
                <p>💧 10x10 grid guessing battle</p>
              </div>
            </div>
          ...
          <Card className="glow-border bg-black/60 backdrop-blur border-2 p-4 lg:p-8 mb-8">
            {hasPlacedBet ? (
              <BattleFlushBoard gameBet={betAmount} />
            ) : (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <p className="text-muted-foreground mb-4">Place a bet to start Battle Breach</p>
