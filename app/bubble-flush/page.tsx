...
import BubbleFlushBoard from "@/components/games/bubble-flush-board"
...
export default function BubbleFlushPage() {
  ...
  const game = {
    name: "Bubble Flush",
    lore: "Poop bubbles burst into plunger holes. Shoot colored bubbles to match 3+, cascade wins!",
  }
      ...
      <div className="relative z-10 flex-1 py-8 px-4 lg:px-6 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-8">
            <div className="flex-1">
              ...
              <div className="mt-4 text-xs text-muted-foreground space-y-1">
                ...
                <p>🎯 Goal: Race to 500 points</p>
                <p>💥 Match 3+ bubbles to burst and score</p>
                <p>⚡ Power-ups: Random El Shito abilities</p>
                <p>📐 Adjust angle, click to shoot, cascade wins!</p>
              </div>
            </div>
          ...
          <Card className="glow-border bg-black/60 backdrop-blur border-2 p-4 lg:p-8 mb-8">
            {hasPlacedBet ? (
              <BubbleFlushBoard gameBet={betAmount} />
            ) : (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <p className="text-muted-foreground mb-4">Place a bet to start playing Bubble Flush</p>
