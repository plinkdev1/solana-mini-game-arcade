...
import RummyClogBoard from "@/components/games/rummy-clog-board"
...
export default function RummyClogPage() {
  ...
  const game = {
    name: "Rummy Rush",
    lore: "Meld clog groups faster than your opponent. Sets and runs create the ultimate flush.",
  }
  ...
  const handleBetPlaced = (amount: number) => {
    ...
    toast({
      title: "Game Started",
      description: `Bet of ${amount} $DATX locked in. Meld faster!`,
    })
  }
      ...
      <div className="relative z-10 flex-1 py-8 px-4 lg:px-6 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-8">
            <div className="flex-1">
              ...
              <div className="mt-4 text-xs text-muted-foreground space-y-1">
                ...
                <p>🃏 Goal: Meld all cards (sets or runs)</p>
                <p>📦 Sets: 3+ same rank cards (clog groups)</p>
                <p>🎯 Runs: 3+ consecutive same suit</p>
                <p>🌀 Swirl Draw: Extra card power-up</p>
              </div>
            </div>
          ...
          <Card className="glow-border bg-black/60 backdrop-blur border-2 p-4 lg:p-8 mb-8">
            {hasPlacedBet ? (
              <RummyClogBoard gameBet={betAmount} />
            ) : (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <p className="text-muted-foreground mb-4">Place a bet to start Rummy Rush</p>
