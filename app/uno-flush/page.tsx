...
import UnoFlushBoard from "@/components/games/uno-flush-board"
...
export default function UnoFlushPage() {
  ...
  const game = {
    ...
    lore: "Match colors or numbers. Play specials. Reach one card and flush victory!",
  }
  ...
  const handleBetPlaced = (amount: number) => {
    ...
    toast({
      title: "Game Started",
      description: `Bet of ${amount} $DATX locked in. One card flush!`,
    })
  }
      ...
      <div className="relative z-10 flex-1 py-8 px-4 lg:px-6 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-8">
            <div className="flex-1">
              ...
              <div className="mt-4 text-xs text-muted-foreground space-y-1">
                ...
                <p>🎴 Goal: Play all cards (one flush!)</p>
                <p>🌈 Match: Color or number on discard pile</p>
                <p>⚡ Special: Skip, Reverse, +2 cards</p>
                <p>🎯 Wilds: Change color, draw four</p>
                <p>💨 Plunger Wild: Extra wild card power-up</p>
              </div>
            </div>
          ...
          <Card className="glow-border bg-black/60 backdrop-blur border-2 p-4 lg:p-8 mb-8">
            {hasPlacedBet ? (
              <UnoFlushBoard gameBet={betAmount} />
            ) : (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <p className="text-muted-foreground mb-4">Place a bet to start Uno Underground</p>
