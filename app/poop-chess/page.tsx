...
import PoopChessBoard from "@/components/games/poop-chess-board"
...
export default function PoopChessPage() {
  ...
  const game = {
    name: "Royal Flush",
    lore: "Poop pawns clash with plunger kings across the throne. Flush the opponent's king to victory.",
  }
  ...
  const handleBetPlaced = (amount: number) => {
    ...
    toast({
      title: "Game Started",
      description: `Bet of ${amount} $DATX locked in. Flush the King!`,
    })
  }
      ...
      <div className="relative z-10 flex-1 py-8 px-6 overflow-y-auto">
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="glow-border bg-black/60 backdrop-blur border-2 p-8 mb-8">
            {hasPlacedBet ? (
              <PoopChessBoard gameBet={betAmount} />
            ) : (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <p className="text-muted-foreground mb-4">Place a bet to Flush the King</p>
