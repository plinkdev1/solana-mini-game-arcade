  ...
  return (
    <div className="relative w-full py-16 px-4 mb-12 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center z-10">
        ...
        <p className="text-xl text-foreground/80 font-medium">Sewer Style – Clear & Simple Cookie Transparency</p>
        <div className="mt-6 flex items-center justify-center gap-2 text-sm text-foreground/60">
          <span className="px-3 py-1 rounded-full border border-accent/50 bg-accent/10">Essential Only</span>
          <span className="px-3 py-1 rounded-full border border-primary/50 bg-primary/10">No Tracking</span>
          <span className="px-3 py-1 rounded-full border border-accent/50 bg-accent/10">GDPR Ready</span>
        </div>
      </div>
    </div>
  )
