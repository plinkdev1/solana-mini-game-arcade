  ...
  return (
    <div className="relative py-12 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-accent mb-2">Play to Flush</p>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Master the Sewer Arena. Learn game rules, betting mechanics, and El Shito power-up systems to dominate the
          competition.
        </p>
      </div>
    </div>
